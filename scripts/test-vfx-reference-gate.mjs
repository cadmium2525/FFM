...
// User-approved legacy exception: these 87 sequences existed before the
...
assert.equal(GRANDFATHERED_PROVISIONAL_SCENES.size, 87, 'legacy VFX exception list changed');
