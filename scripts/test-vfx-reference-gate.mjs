...
// User-approved legacy exception: these 109 sequences existed before the
...
assert.equal(GRANDFATHERED_PROVISIONAL_SCENES.size, 109, 'legacy VFX exception list changed');
